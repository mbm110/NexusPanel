...
<div class="wrap">
  <div class="card">
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='NEXUSKING';document.getElementById('pw').focus()">NEXUSKING</span>
    </div>
    <form id="form">
      <div class="field">
    ...
    <div class="footer">پشتیبانی <a href="https://t.me/support" target="_blank"><i class="ti ti-brand-telegram"></i>@Farajian2004f</a></div>
  </div>
</div>
<script>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">NexusPanel v1.0 · Railway</span>
    <a class="df-link" href="https://t.me/support" target="_blank"><i class="ti ti-brand-telegram"></i> t.me/support</a>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    ...
    <div class="srv-tiles">
      <a class="srv-tile" href="https://www.youtube.com" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">youtube.com</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/support" target="_blank" style="text-decoration:none;cursor:pointer">
      ...
      <a class="srv-tile" href="https://t.me/support" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val">t.me/support</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/support" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-speakerphone"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">کانال تلگرام</div><div class="srv-tile-val">t.me/support</div></div>
      </a>
...
<div class="wrap">
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/support" target="_blank">@Farajian2004f</a> · NexusPanel v1.0</div>
</div>
<script>
